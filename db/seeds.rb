...
candidate1 = User.new(first_name: "Anna", last_name: "Sanchez", email: "alison@datatog.com", password: "seb@lewagon.org", city: "Buenos-Aires(🇦🇷)", job: "Data scientist", level: 4, timezone: "BST GMT-3", expected_wage: 67, current_employer: "Facebook" , status: "In Magellan", university: "Engineering at University of Chile (1st university Chile)", relocation_possible: true, full_remote_only: true, contractor_possible: true)
...
candidate2 = User.new(first_name: "Roberto", last_name: "De Vez", email: "alison1@datatog.com", password: "seb1@lewagon.org", city: "Rio de Janeiro(🇧🇷)", job: "Software Engineer", level: 4, timezone: "BST GMT-3", expected_wage: 57, current_employer: "Facebook" , status: "In Magellan", university: "Engineering at University of Chile (1st university Chile)", relocation_possible: true, full_remote_only: true, contractor_possible: true)
...
candidate3 = User.new(first_name: "Kevin", last_name: "Michel", email: "alison11@datatog.com", password: "seb11@lewagon.org", city: "Rio de Janeiro(🇧🇷)", job: "Software Engineer", level: 4, timezone: "BST GMT-3", expected_wage: 47, current_employer: "Facebook" , status: "In Magellan", university: "Engineering at University of Chile (1st university Chile)", relocation_possible: true, full_remote_only: true, contractor_possible: true)
